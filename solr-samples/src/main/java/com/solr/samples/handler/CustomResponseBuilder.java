...
public class CustomResponseBuilder extends ResponseBuilder
{
    ...
    public SolrRequestInfo requestInfo;

    public CustomResponseBuilder(SolrQueryRequest req, SolrQueryResponse rsp, List<SearchComponent> components)
    {
    ...
    public boolean isDistrib; // is this a distributed search?
